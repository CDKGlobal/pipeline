...
public class ProjectReportFactory {
	 ...
	 */
    public static ProjectReport createCDResult(Plan plan, ContributorBuilder contributorBuilder,
        ...
        ProjectReport cdresult = new ProjectReport(projectName, strippedPlanName, projectKey, planKey);
	 ...
	 */
    protected static void setLastDeploymentInfo(ProjectReport cdresult, Plan plan, ResultsSummaryManager resultsSummaryManager,
	 ...
	 */
    protected static void setCurrentBuildInfo(ProjectReport cdresult, List<ResultsSummary> buildList,
	 ...
	 */
    protected static void addAllAuthorsInCommits(ProjectReport cdresult, List<Commit> commits,
                                                 ContributorBuilder contributorBuilder) {
        for(Commit commit : commits) {
            ...
            if (!cdresult.containsContributor(username) && contributorBuilder != null) {
	 ...
	 */
    protected static void setPipelineStages(ProjectReport cdresult, ChainResultsSummary buildResult) {
	 ...
	 */
    protected static void setLastUpdateTime(ProjectReport cdresult, ChainResultsSummary buildResult) {
