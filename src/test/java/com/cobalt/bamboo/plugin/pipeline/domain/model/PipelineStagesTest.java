...
public class PipelineStagesTest {
	...
	public void testEmptyStageChain() {
        ProjectReport cdr = new ProjectReport("test", "test", "test", "test");
        ProjectReportFactory.setPipelineStages(cdr, noStage);
	...
	public void testOneStageChain(){
        ProjectReport cdr = new ProjectReport("test", "test", "test", "test");
        ProjectReportFactory.setPipelineStages(cdr, oneStage);
        List<PipelineStage> pipes = cdr.getPipelineStages();
	...
	public void testLengthOfStagesChainWithIdenticalName(){
        ...
        ProjectReport cdr = new ProjectReport("test", "test", "test", "test");
        ProjectReportFactory.setPipelineStages(cdr, chain5);
        List<PipelineStage> pipes = cdr.getPipelineStages();
        ...
        cdr = new ProjectReport("test", "test", "test", "test");
        ProjectReportFactory.setPipelineStages(cdr, chain100);
	...
	public void testFirstStageInChainWithDifferentStates(){
        ProjectReport cdr = new ProjectReport("test", "test", "test", "test");
        ProjectReportFactory.setPipelineStages(cdr, chain1);
        List<PipelineStage> pipes = cdr.getPipelineStages();
