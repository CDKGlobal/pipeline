...
public class SetCurrentBuildInfoTest {
	...
	public void testWithNoBuilds() {
        ProjectReport cdr = new ProjectReport("Project", "Project - Plan", "project", "plan");
        ProjectReportFactory.setCurrentBuildInfo(cdr, createNBuildResults(0), mock(PlanExecutionManager.class));
	...
	private void testForNBuilds(int N) {
        ...
        ProjectReport cdr = new ProjectReport("Project", "Project - Plan", "project", "plan");
        ProjectReportFactory.setCurrentBuildInfo(cdr, buildList, mock(PlanExecutionManager.class));
