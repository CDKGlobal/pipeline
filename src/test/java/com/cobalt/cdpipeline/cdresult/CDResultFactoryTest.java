...
public class CDResultFactoryTest {
	...
	public void testConstructorWithNullArguments() {
		CDResultFactory fac = new CDResultFactory(null, null, null);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testConstructorWithInvalidPlanName() {
		CDResultFactory fac = new CDResultFactory("project", "projectplan", new ArrayList<ResultsSummary>());
	}
	
	@Test
	public void testConstructorWithNormalArguments() {
		CDResultFactory fac = new CDResultFactory("Project", "Project - Plan", new ArrayList<ResultsSummary>());
